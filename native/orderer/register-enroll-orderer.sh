...
function    checkCopyYAML {
    SETUP_CONFIG_CLIENT_YAML="../configs/ca/Orderer/ordererClient/fabric-ca-client-config.yaml"
...
# Identity of the orderer will be created by the admin from the orderer hopsital
IDENTITY="admin"
