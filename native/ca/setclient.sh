# Sets the FABRIC_CA_CLIENT_HOME based on (a) hopsital (b) enrollment ID

function usage {
    echo    "Usage:    .   ./setclient.sh   HOSPITAL-Name   Enrollment-ID"
...
then
    usage
    echo   "To CHANGE please provide HOSPITAL-Name & enrollment ID"
    exit 1
fi
