...
# Takes the hopsital name and "enrollment-id" 
# Use this script if you want to play with identity creation/removal
function usage {
    echo    "Usage:    .   ./remove-identity.sh   HOSPITAL-Name   Enrollment-ID"
...
then
    usage
    echo   "To REMOVE identity please HOSPITAL-Name & enrollment ID"
    exit 0
else
    ORG_NAME=$1
fi
