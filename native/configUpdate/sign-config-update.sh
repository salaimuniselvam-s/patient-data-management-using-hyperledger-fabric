...
# E.g.,   ./sign-config-update.sh   hospital1       Signs the file with hospital1 admin certificate/key
# E.g.,   ./sign-config-update.sh   hospital2     Signs the file with hospital2 admin certificate/key
function usage {
