...
const Doctor_Admin_ProfileCard: React.FC<profileCard> = ({
  ...
  return (
    <div className={`${isProfile && "lg:w-1/3 max-md:1/2"} flex justify-center`}>
      <div className={`${isProfile && 'h-80'} p-8 md:p-2 w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700`}>
        <div className={`${isProfile ? 'flex-col': 'flex-row'} flex items-center mr-6 ml-6`}>
          {isProfile ? (
            <div>
          ...
          <h5 style={{textShadow: '4px 4px 2px #000'}} className="mb-1 text-xl font-medium text-gray-900 dark:text-white mr-3 ml-3">
            {username} <br />
          ...
          {isProfile && (
            <div className={`${isProfile && 'mt-3'} flex items-center flex-col ml-5`}>
