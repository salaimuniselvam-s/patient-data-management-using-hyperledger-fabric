...
# hopsital in the "organizations" directory.
...
function createOrgs() {
  ...
  if [ "$CRYPTO" == "cryptogen" ]; then
    ...
    echo "##########################################################"
    echo "############ Create Hopsital2 Identities ######################"
    echo "##########################################################"
...
# peer hopsital. In future steps, this same file is used to create the channel creation
...
# After we create the hopsital crypto material and the system channel genesis block,
...
## call the script to join create the channel and join the peers of hospital1 and hospital2
...
# use this as the docker compose couch file for hospital3
COMPOSE_FILE_COUCH_ORG3=addHospital3/docker/docker-compose-couch-hospital3.yaml
# use this as the default docker-compose yaml definition for hospital3
COMPOSE_FILE_ORG3=addHospital3/docker/docker-compose-hospital3.yaml
#
