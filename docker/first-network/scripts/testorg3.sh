...
# chaincode requests through the hospital3 peers to check that hospital3 was
...
# Query chaincode on peer0.hospital3, check if the result is 90
echo "Querying chaincode on peer0.hospital3..."
chaincodeQuery 0 3 90

# Invoke chaincode on peer0.hospital1 and peer0.hospital3
echo "Sending invoke transaction on peer0.hospital1 peer0.hospital3..."
chaincodeInvoke 0 0 1 0 3

# Query on chaincode on peer0.hospital3, peer0.hospital2, peer0.hospital1 check if the result is 80
