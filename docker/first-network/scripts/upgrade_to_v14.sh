...
#Query on chaincode on Peer0/Hopsital1
echo "Querying chaincode on hospital1/peer0..."
chaincodeQuery 0 1 90

sleep $DELAY

#Invoke on chaincode on Peer0/Hopsital1
echo "Sending invoke transaction on hospital1/peer0..."
