...
```
docker run -it --rm --name fabcar.hospital1.geakminds.com --hostname fabcar.hospital1.geakminds.com --env-file chaincode.env --network=net_test hyperledger/fabcar-sample
```
