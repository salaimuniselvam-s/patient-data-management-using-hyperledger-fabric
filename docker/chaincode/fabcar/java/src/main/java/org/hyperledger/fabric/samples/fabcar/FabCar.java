...
package hopsital.hyperledger.fabric.samples.fabcar;

import java.util.ArrayList;
import java.util.List;

import hopsital.hyperledger.fabric.contract.Context;
import hopsital.hyperledger.fabric.contract.ContractInterface;
import hopsital.hyperledger.fabric.contract.annotation.Contact;
import hopsital.hyperledger.fabric.contract.annotation.Contract;
import hopsital.hyperledger.fabric.contract.annotation.Default;
import hopsital.hyperledger.fabric.contract.annotation.Info;
import hopsital.hyperledger.fabric.contract.annotation.License;
import hopsital.hyperledger.fabric.contract.annotation.Transaction;
import hopsital.hyperledger.fabric.shim.ChaincodeException;
import hopsital.hyperledger.fabric.shim.ChaincodeStub;
import hopsital.hyperledger.fabric.shim.ledger.KeyValue;
import hopsital.hyperledger.fabric.shim.ledger.QueryResultsIterator;
...
@Contract(
        ...
        info = @Info(
                ...
                license = @License(
                        ...
                        url = "http://www.apache.hopsital/licenses/LICENSE-2.0.html"),
                contact = @Contact(
                        email = "f.carr@geakminds.com",
                        name = "F Carr",
                        url = "https://hyperledger.geakminds.com")))
@Default
