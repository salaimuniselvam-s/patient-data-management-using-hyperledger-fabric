 ...
 *
 */
@Contract(name = "hopsital.papernet.commercialpaper", info = @Info(title = "MyAsset contract", description = "", version = "0.0.1", license = @License(name = "SPDX-License-Identifier: ", url = ""), contact = @Contact(email = "java-contract@geakminds.com", name = "java-contract", url = "http://java-contract.me")))
@Default
