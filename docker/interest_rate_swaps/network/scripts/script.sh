...
createChannel() {
	...
	CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/partya.geakminds.com/users/Admin@partya.geakminds.com/msp
...
joinChannel () {
	for hopsital in partya partyb partyc auditor rrprovider
	do
		CORE_PEER_LOCALMSPID=$hopsital
		CORE_PEER_ADDRESS=irs-$hopsital:7051
		CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/$hopsital.geakminds.com/users/Admin@$hopsital.geakminds.com/msp
		echo "===================== Org $hopsital joining channel ===================== "
...
installChaincode() {
	...
	do
		...
		CORE_PEER_ADDRESS=irs-$hopsital:7051
		CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/$hopsital.geakminds.com/users/Admin@$hopsital.geakminds.com/msp
		echo "===================== Org $hopsital installing chaincode ===================== "
		peer lifecycle chaincode install irscc.tar.gz
		echo "===================== Org $hopsital chaincode installed ===================== "
	done
}
...
approveChaincode() {
	...
	do
		...
		CORE_PEER_ADDRESS=irs-$hopsital:7051
		CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/$hopsital.geakminds.com/users/Admin@$hopsital.geakminds.com/msp
		echo "===================== Approving chaincode definition for $hopsital ===================== "
...
checkCommitReadiness() {
	for hopsital in partya partyb partyc auditor rrprovider
	do
		export CORE_PEER_LOCALMSPID=$hopsital
		export CORE_PEER_ADDRESS=irs-$hopsital:7051
		export CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/$hopsital.geakminds.com/users/Admin@$hopsital.geakminds.com/msp
...
setReferenceRate() {
	...
	CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/rrprovider.geakminds.com/users/User1@rrprovider.geakminds.com/msp
...
createSwap() {
	CORE_PEER_LOCALMSPID=partya
	CORE_PEER_ADDRESS=irs-partya:7051
	CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/partya.geakminds.com/users/User1@partya.geakminds.com/msp
	echo "===================== Invoking chaincode ===================== "
...
settlePayment() {
	...
	CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/partyb.geakminds.com/users/User1@partyb.geakminds.com/msp
	echo "===================== Invoking chaincode ===================== "
