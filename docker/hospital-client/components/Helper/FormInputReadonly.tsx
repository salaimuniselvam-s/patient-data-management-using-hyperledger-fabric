  ...
  return (
    <div className="relative">
      <input
        type="text"
        id={id}
        className="block px-4 pb-2.5 pt-4 w-full text-gray-900 bg-transparent rounded-lg border border-gray-500 appearance-none dark:text-white focus:ring-primary-600 focus:border-primary-600 dark:focus:ring-blue-500 dark:focus:border-blue-500 outline-none   peer"
        value={value}
        // readOnly
      />
      <label
